class XcodegenRs < Formula
  desc "Rust implementation of XcodeGen-compatible project generation"
  homepage "https://github.com/min/xcodegen-rs"
  url "https://github.com/min/xcodegen-rs.git", branch: "main"
  version "0.1.0"
  license "MIT"

  head "https://github.com/min/xcodegen-rs.git", branch: "main"
