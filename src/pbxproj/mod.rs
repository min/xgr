...
impl<'a> PbxGenerator<'a> {
        ...
        match self.effective_source_type(source) {
            ...
            SourceType::Group | SourceType::Other(_) => {
                ...
                let parent_relative = pathdiff(parent, &self.project.base_path)
                    .to_string_lossy()
                    .into_owned();
                let group_parent_storage;
                let group_parent = if let Some(group) = source.group.as_deref() {
                    if group == parent_relative {
                        parent
                    } else if parent_relative.starts_with(&format!("{group}/")) {
                        group_parent_storage = self.project.base_path.join(group);
                        group_parent_storage.as_path()
                    } else {
                        self.project.base_path.as_path()
                    }
                } else if self.should_create_intermediate_groups(source) {
            ...
            self.add_group(
                ...
                (root
                    && (source.name.is_some()
                        ...
                        || display_name(&group_path) != group_path))
    ...
    fn add_regular_source_file_reference(
        ...
        let last_known_file_type = xcode_file_type_for_path(&relative).map(str::to_owned);
        self.add_file_reference(
...
pub(super) fn is_watch_app_product(product_type: &ProductType) -> bool {
...
pub(super) fn project_xcode_version_last_upgrade_check(project: &Project) -> Option<String> {
    let value = project
        .options
        .get("xcodeVersion")
        .and_then(json_string_value)?;
...
fn file_type_for_path(path: &str, product_type: Option<&ProductType>) -> String {
    if let Some(product_type) = product_type {
        return match product_type {
            ...
            ProductType::ExtensionKitExtension => "wrapper.extensionkit-extension",
    ...
    xcode_file_type_for_path(path).unwrap_or("file").to_owned()
}

// Local copy of XcodeProj 9.10.1's Xcode.filetype(extension:) table, plus
// XcodeGen's overrides for file types not handled by that release.
fn xcode_file_type_for_path(path: &str) -> Option<&'static str> {
    match Path::new(path)
        .extension()
        .and_then(|extension| extension.to_str())
    {
        Some("1") => Some("text.man"),
        Some("C") => Some("sourcecode.cpp.cpp"),
        Some("H") => Some("sourcecode.cpp.h"),
        Some("M") => Some("sourcecode.cpp.objcpp"),
        Some("a") => Some("archive.ar"),
        Some("ada") => Some("sourcecode.ada"),
        Some("adb") => Some("sourcecode.ada"),
        Some("ads") => Some("sourcecode.ada"),
        Some("aiff") => Some("audio.aiff"),
        Some("air") => Some("compiled.air"),
        Some("apinotes") => Some("text.apinotes"),
        Some("apns") => Some("text"),
        Some("app") => Some("wrapper.application"),
        Some("appex") => Some("wrapper.app-extension"),
        Some("applescript") => Some("sourcecode.applescript"),
        Some("archivingdescription") => Some("text.xml.ibArchivingDescription"),
        Some("asdictionary") => Some("archive.asdictionary"),
        Some("asm") => Some("sourcecode.asm.asm"),
        Some("atlas") => Some("folder.skatlas"),
        Some("au") => Some("audio.au"),
        Some("avi") => Some("video.avi"),
        Some("bazel") => Some("text.script.python"),
        Some("bin") => Some("archive.macbinary"),
        Some("bmp") => Some("image.bmp"),
        Some("bundle") => Some("wrapper.cfbundle"),
        Some("bzl") => Some("text.script.python"),
        Some("c") => Some("sourcecode.c.c"),
        Some("c++") => Some("sourcecode.cpp.cpp"),
        Some("cc") => Some("sourcecode.cpp.cpp"),
        Some("cdda") => Some("audio.aiff"),
        Some("cl") => Some("sourcecode.opencl"),
        Some("class") => Some("compiled.javaclass"),
        Some("classdescription") => Some("text.plist.ibClassDescription"),
        Some("classdescriptions") => Some("text.plist.ibClassDescription"),
        Some("clp") => Some("sourcecode.clips"),
        Some("cp") => Some("sourcecode.cpp.cpp"),
        Some("cpp") => Some("sourcecode.cpp.cpp"),
        Some("csh") => Some("text.script.csh"),
        Some("css") => Some("text.css"),
        Some("ctrl") => Some("sourcecode.glsl"),
        Some("cxx") => Some("sourcecode.cpp.cpp"),
        Some("d") => Some("sourcecode.dtrace"),
        Some("dSYM") => Some("wrapper.dsym"),
        Some("dae") => Some("text.xml.dae"),
        Some("defs") => Some("sourcecode.mig"),
        Some("dext") => Some("wrapper.driver-extension"),
        Some("dict") => Some("text.plist"),
        Some("docc") => Some("folder.documentationcatalog"),
        Some("dsym") => Some("wrapper.dsym"),
        Some("dtd") => Some("text.xml"),
        Some("dylan") => Some("sourcecode.dylan"),
        Some("dylib") => Some("compiled.mach-o.dylib"),
        Some("ear") => Some("archive.ear"),
        Some("entitlements") => Some("text.plist.entitlements"),
        Some("eval") => Some("sourcecode.glsl"),
        Some("exp") => Some("sourcecode.exports"),
        Some("f") => Some("sourcecode.fortran"),
        Some("f77") => Some("sourcecode.fortran.f77"),
        Some("f90") => Some("sourcecode.fortran.f90"),
        Some("f95") => Some("sourcecode.fortran.f90"),
        Some("for") => Some("sourcecode.fortran"),
        Some("frag") => Some("sourcecode.glsl"),
        Some("fragment") => Some("sourcecode.glsl"),
        Some("framework") => Some("wrapper.framework"),
        Some("fs") => Some("sourcecode.glsl"),
        Some("fsh") => Some("sourcecode.glsl"),
        Some("geom") => Some("sourcecode.glsl"),
        Some("geometry") => Some("sourcecode.glsl"),
        Some("gif") => Some("image.gif"),
        Some("gmk") => Some("sourcecode.make"),
        Some("gpx") => Some("text.xml"),
        Some("gs") => Some("sourcecode.glsl"),
        Some("gsh") => Some("sourcecode.glsl"),
        Some("gz") => Some("archive.gzip"),
        Some("h") => Some("sourcecode.c.h"),
        Some("h++") => Some("sourcecode.cpp.h"),
        Some("hh") => Some("sourcecode.cpp.h"),
        Some("hp") => Some("sourcecode.cpp.h"),
        Some("hpp") => Some("sourcecode.cpp.h"),
        Some("hqx") => Some("archive.binhex"),
        Some("htm") => Some("text.html"),
        Some("html") => Some("text.html"),
        Some("htmld") => Some("wrapper.htmld"),
        Some("hxx") => Some("sourcecode.cpp.h"),
        Some("i") => Some("sourcecode.c.c.preprocessed"),
        Some("icns") => Some("image.icns"),
        Some("ico") => Some("image.ico"),
        Some("icon") => Some("wrapper.icon"),
        Some("iconset") => Some("folder.iconset"),
        Some("ii") => Some("sourcecode.cpp.cpp.preprocessed"),
        Some("iig") => Some("sourcecode.iig"),
        Some("imagecatalog") => Some("folder.imagecatalog"),
        Some("inc") => Some("sourcecode.pascal"),
        Some("instrdst") => Some("com.apple.instruments.instrdst"),
        Some("instrpkg") => Some("com.apple.instruments.package-definition"),
        Some("intentdefinition") => Some("file.intentdefinition"),
        Some("ipp") => Some("sourcecode.cpp.h"),
        Some("jam") => Some("sourcecode.jam"),
        Some("jar") => Some("archive.jar"),
        Some("java") => Some("sourcecode.java"),
        Some("javascript") => Some("sourcecode.javascript"),
        Some("jpeg") => Some("image.jpeg"),
        Some("jpg") => Some("image.jpeg"),
        Some("js") => Some("sourcecode.javascript"),
        Some("jscript") => Some("sourcecode.javascript"),
        Some("json") => Some("text.json"),
        Some("jsp") => Some("text.html.other"),
        Some("kext") => Some("wrapper.kernel-extension"),
        Some("l") => Some("sourcecode.lex"),
        Some("lid") => Some("sourcecode.dylan"),
        Some("ll") => Some("sourcecode.asm.llvm"),
        Some("llx") => Some("sourcecode.asm.llvm"),
        Some("lm") => Some("sourcecode.lex"),
        Some("lmm") => Some("sourcecode.lex"),
        Some("lp") => Some("sourcecode.lex"),
        Some("lpp") => Some("sourcecode.lex"),
        Some("lxx") => Some("sourcecode.lex"),
        Some("m") => Some("sourcecode.c.objc"),
        Some("mak") => Some("sourcecode.make"),
        Some("make") => Some("sourcecode.make"),
        Some("map") => Some("sourcecode.module-map"),
        Some("markdown") => Some("net.daringfireball.markdown"),
        Some("md") => Some("net.daringfireball.markdown"),
        Some("mdimporter") => Some("wrapper.spotlight-importer"),
        Some("mdown") => Some("net.daringfireball.markdown"),
        Some("metal") => Some("sourcecode.metal"),
        Some("metallib") => Some("archive.metal-library"),
        Some("mi") => Some("sourcecode.c.objc.preprocessed"),
        Some("mid") => Some("audio.midi"),
        Some("midi") => Some("audio.midi"),
        Some("mig") => Some("sourcecode.mig"),
        Some("mii") => Some("sourcecode.cpp.objcpp.preprocessed"),
        Some("mlkitmodel") => Some("file.mlmodel"),
        Some("mlmodel") => Some("file.mlmodel"),
        Some("mm") => Some("sourcecode.cpp.objcpp"),
        Some("modulemap") => Some("sourcecode.module-map"),
        Some("moov") => Some("video.quicktime"),
        Some("mov") => Some("video.quicktime"),
        Some("mp3") => Some("audio.mp3"),
        Some("mpeg") => Some("video.mpeg"),
        Some("mpg") => Some("video.mpeg"),
        Some("mpkg") => Some("wrapper.installer-mpkg"),
        Some("nasm") => Some("sourcecode.nasm"),
        Some("nib") => Some("wrapper.nib"),
        Some("nib~") => Some("wrapper.nib"),
        Some("nqc") => Some("sourcecode.nqc"),
        Some("o") => Some("compiled.mach-o.objfile"),
        Some("octest") => Some("wrapper.cfbundle"),
        Some("otf") => Some("file"),
        Some("p") => Some("sourcecode.pascal"),
        Some("pas") => Some("sourcecode.pascal"),
        Some("pbfilespec") => Some("text.plist.pbfilespec"),
        Some("pblangspec") => Some("text.plist.pblangspec"),
        Some("pbxproj") => Some("text.pbxproject"),
        Some("pch") => Some("sourcecode.c.h"),
        Some("pch++") => Some("sourcecode.cpp.h"),
        Some("pct") => Some("image.pict"),
        Some("pdf") => Some("image.pdf"),
        Some("perl") => Some("text.script.perl"),
        Some("php") => Some("text.script.php"),
        Some("php3") => Some("text.script.php"),
        Some("php4") => Some("text.script.php"),
        Some("phtml") => Some("text.script.php"),
        Some("pict") => Some("image.pict"),
        Some("pkg") => Some("wrapper.installer-pkg"),
        Some("pl") => Some("text.script.perl"),
        Some("playground") => Some("file.playground"),
        Some("plist") => Some("text.plist"),
        Some("pluginkit") => Some("wrapper.app-extension"),
        Some("pm") => Some("text.script.perl"),
        Some("png") => Some("image.png"),
        Some("pp") => Some("sourcecode.pascal"),
        Some("ppob") => Some("archive.ppob"),
        Some("proto") => Some("sourcecode.protobuf"),
        Some("py") => Some("text.script.python"),
        Some("qtz") => Some("video.quartz-composer"),
        Some("r") => Some("sourcecode.rez"),
        Some("rb") => Some("text.script.ruby"),
        Some("rbw") => Some("text.script.ruby"),
        Some("rcproject") => Some("file.rcproject"),
        Some("rcx") => Some("compiled.rcx"),
        Some("rez") => Some("sourcecode.rez"),
        Some("rhtml") => Some("text.html.other"),
        Some("rsrc") => Some("archive.rsrc"),
        Some("rtf") => Some("text.rtf"),
        Some("rtfd") => Some("wrapper.rtfd"),
        Some("s") => Some("sourcecode.asm"),
        Some("scnassets") => Some("wrapper.scnassets"),
        Some("scncache") => Some("wrapper.scncache"),
        Some("scnp") => Some("file.scp"),
        Some("scriptSuite") => Some("text.plist.scriptSuite"),
        Some("scriptTerminology") => Some("text.plist.scriptTerminology"),
        Some("sh") => Some("text.script.sh"),
        Some("shtml") => Some("text.html.other"),
        Some("sit") => Some("archive.stuffit"),
        Some("sks") => Some("file.sks"),
        Some("skybox") => Some("file.skybox"),
        Some("sqlite") => Some("file"),
        Some("storyboard") => Some("file.storyboard"),
        Some("storyboardc") => Some("wrapper.storyboardc"),
        Some("strings") => Some("text.plist.strings"),
        Some("stringsdict") => Some("text.plist.stringsdict"),
        Some("swift") => Some("sourcecode.swift"),
        Some("swiftcrossimport") => Some("wrapper.swiftcrossimport"),
        Some("systemextension") => Some("wrapper.system-extension"),
        Some("tar") => Some("archive.tar"),
        Some("tbd") => Some("sourcecode.text-based-dylib-definition"),
        Some("tcc") => Some("sourcecode.cpp.cpp"),
        Some("text") => Some("net.daringfireball.markdown"),
        Some("tif") => Some("image.tiff"),
        Some("tiff") => Some("image.tiff"),
        Some("ttf") => Some("file"),
        Some("txt") => Some("text"),
        Some("uicatalog") => Some("file.uicatalog"),
        Some("usdz") => Some("file.usdz"),
        Some("vert") => Some("sourcecode.glsl"),
        Some("vertex") => Some("sourcecode.glsl"),
        Some("view") => Some("archive.rsrc"),
        Some("vs") => Some("sourcecode.glsl"),
        Some("vsh") => Some("sourcecode.glsl"),
        Some("war") => Some("archive.war"),
        Some("wav") => Some("audio.wav"),
        Some("worksheet") => Some("text.script.worksheet"),
        Some("xcassets") => Some("folder.assetcatalog"),
        Some("xcbuildrules") => Some("text.plist.xcbuildrules"),
        Some("xcclassmodel") => Some("wrapper.xcclassmodel"),
        Some("xcconfig") => Some("text.xcconfig"),
        Some("xcdatamodel") => Some("wrapper.xcdatamodel"),
        Some("xcdatamodeld") => Some("wrapper.xcdatamodeld"),
        Some("xcfilelist") => Some("text.xcfilelist"),
        Some("xcframework") => Some("wrapper.xcframework"),
        Some("xclangspec") => Some("text.plist.xclangspec"),
        Some("xcmappingmodel") => Some("wrapper.xcmappingmodel"),
        Some("xcode") => Some("wrapper.pb-project"),
        Some("xcodeproj") => Some("wrapper.pb-project"),
        Some("xconf") => Some("text.xml"),
        Some("xcplaygroundpage") => Some("file.xcplaygroundpage"),
        Some("xcspec") => Some("text.plist.xcspec"),
        Some("xcstickers") => Some("folder.stickers"),
        Some("xcstrings") => Some("text.json.xcstrings"),
        Some("xcsynspec") => Some("text.plist.xcsynspec"),
        Some("xctarget") => Some("wrapper.pb-target"),
        Some("xctest") => Some("wrapper.cfbundle"),
        Some("xctxtmacro") => Some("text.plist.xctxtmacro"),
        Some("xcworkspace") => Some("wrapper.workspace"),
        Some("xhtml") => Some("text.xml"),
        Some("xib") => Some("file.xib"),
        Some("xmap") => Some("text.xml"),
        Some("xml") => Some("text.xml"),
        Some("xpc") => Some("wrapper.xpc-service"),
        Some("xsl") => Some("text.xml"),
        Some("xslt") => Some("text.xml"),
        Some("xsp") => Some("text.xml"),
        Some("y") => Some("sourcecode.yacc"),
        Some("yaml") => Some("text.yaml"),
        Some("ym") => Some("sourcecode.yacc"),
        Some("yml") => Some("text.yaml"),
        Some("ymm") => Some("sourcecode.yacc"),
        Some("yp") => Some("sourcecode.yacc"),
        Some("ypp") => Some("sourcecode.yacc"),
        Some("yxx") => Some("sourcecode.yacc"),
        Some("zip") => Some("archive.zip"),
        _ => None,
    }
}
